...
public class KeypadController : MonoBehaviour
{
    ...
    private void AccessGranted()
    {
        ...
        PaintingRoomManager.Instance.TrySubmitCode(currentInput);
    ...
    {
        // multiplayer safety
        if (!player.GetComponent<Alteruna.Avatar>().IsMe)
            return;

        // puzzle rule
        if (PaintingRoomManager.Instance != null &&
            !PaintingRoomManager.Instance.LocalPlayerIsAffected())
            return;
